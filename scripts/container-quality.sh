...
clang-format --dry-run --Werror \
  Tuxedo-Fan-Control.cpp ec_controller.cpp ec_controller.h fan_curve.cpp \
  fan_curve.h tests/ec_controller_test.cpp tests/fan_curve_test.cpp
...
clang-tidy -p "$BUILD_DIR" \
  Tuxedo-Fan-Control.cpp ec_controller.cpp fan_curve.cpp \
  tests/ec_controller_test.cpp tests/fan_curve_test.cpp --quiet
